...
What we want to implement:
  -full fleged registering and login formulars
  -user profiles
  -store interface for all products and product categories
  -a simple implementation of a live chat
  -maybe a low level encyclopedia about steroids
